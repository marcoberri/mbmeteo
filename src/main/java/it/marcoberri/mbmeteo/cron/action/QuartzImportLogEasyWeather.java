 ...
 */
public class QuartzImportLogEasyWeather implements Job {

    /**
     *
     */
    protected static final org.apache.log4j.Logger log = Log4j.getLogger("quartz_import_ew", ConfigurationHelper.prop.getProperty("log.path"), Log4j.ROTATE_DAILY);
